...
function Ball:init(skin)
    ...
    Ball.instanceCount = Ball.instanceCount + 1
end
...
function Ball:storeSpeed()
    self.storedDx = self.dx
    self.storedDy = self.dy
end

function Ball:restoreSpeed()
    self.dx = self.storedDx
    self.dy = self.storedDy
end
